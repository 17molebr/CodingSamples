   ...
   */
   ...
   public static boolean parseMiner(String[] properties, WorldModel world,
      ...
      if (properties.length == MINER_NUM_PROPERTIES) {
         ...
         Entity m = new MinerNotFull(properties[MINER_ID],pt,imageStore.getImageList(MINER_KEY),0,
                 Integer.parseInt(properties[MINER_ACTION_PERIOD]),
                 Integer.parseInt(properties[MINER_ANIMATION_PERIOD]),Integer.parseInt(properties[MINER_LIMIT])
                 );
   ...
   public static boolean parseObstacle(String[] properties, WorldModel world,
      ...
      if (properties.length == OBSTACLE_NUM_PROPERTIES) {
         ...
         Entity o = new Obstacle(properties[OBSTACLE_ID],
                 pt, imageStore.getImageList(OBSTACLE_KEY));
         world.tryAddEntity(o);
      }
   ...
   public static boolean parseOre(String[] properties, WorldModel world,
      ...
      if (properties.length == ORE_NUM_PROPERTIES) {
         ...
         Entity o = new Ore(properties[ORE_ID],
   ...
   public static boolean parseSmith(String[] properties, WorldModel world,
      ...
      if (properties.length == SMITH_NUM_PROPERTIES) {
         ...
         Entity b = new Blacksmith(properties[SMITH_ID],
                 pt, imageStore.getImageList(SMITH_KEY));
         world.tryAddEntity(b);
      }
   ...
   public static boolean parseVein(String[] properties, WorldModel world,
      ...
      if (properties.length == VEIN_NUM_PROPERTIES) {
         ...
         Entity v = new Vein(pt,imageStore.getImageList(VEIN_KEY),properties[VEIN_ID],
